    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ciudad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='registro.ciudades')),
            ],
        ),
        migrations.CreateModel(
            name='Vehiculo',
            fields=[
                ...
                ('marca', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='registro.marca')),
            ],
            options={
